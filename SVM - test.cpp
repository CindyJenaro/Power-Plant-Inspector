...
int main()
{
	...
	string modelpath = "C:\\Users\\Cindy\\Desktop\\[Don't_Delete!]Project1\\SVM+CNN Related\\Bright\\CROPPED\\svm_auto.xml";
	...
	// positive first
	string positiveFilePath = "C:\\Users\\Cindy\\Desktop\\[Don't_Delete!]Project1\\SVM+CNN Related\\Bright\\CROPPED\\test1";
    ...
    // negative then
    string negativeFilePath = "C:\\Users\\Cindy\\Desktop\\[Don't_Delete!]Project1\\SVM+CNN Related\\Bright\\CROPPED\\test0";
	...
	cout << "TP: " << true_positive << ' ' << "TN: " << true_negative << endl
		 << "FP: " << false_positive << ' ' << "FN: " << false_negative << endl;
    ...
    complete = clock();
    cout << "Total timecost: " << (double)(complete - start)/CLOCKS_PER_SEC << "s" << endl;
	getchar();
	return  0;
}
